...
# #     "reza4.wav", "reza5.wav", "reza6.wav",  "narges2.mp3", "narges3.mp3",
...
# #     "voiceravi30.mp3", "voiceravi31.mp3"
# # ]
...
#     "voice7.mp3", "voice8.mp3", "voice9.mp3", "voice10.mp3", "Ali1.wav", "Ali2.wav",
#     "Ali3.wav", "Ali4.wav", "Ali5.wav", "Ali6.wav", "reza1.wav", "reza2.wav", "reza3.wav",
#     "reza4.wav", "reza5.wav", "reza6.wav", "tavakoli.mp3",
#     "ravi12.mp3", "ravi13.mp3", "ravi14.mp3", "ravi15.mp3", "add1.mp3", "add2.mpeg",
#     "akhar1.mp3", "akhar2.mp3","akhar3.mp3", "akhar4.mp3"
# ]


# # 🔸 مدت سکوت بین فایل‌ها (به میلی‌ثانیه)
# pause_duration = 500  # سکوت معمولی بین فایل‌ها
# silence = AudioSegment.silent(duration=pause_duration)
...
#     # ✳️ بررسی اگر به فایل خاص رسیدیم:
#     if file == "voiceravi31.mp3":
#         # بعد از جمله "و این جمله را با صدای بلند تکرار کنید"
#         combined += silence_5s  # ۵ ثانیه سکوت
#         # بعد از "آماده‌اید:"
#         combined += silence_3s  # ۳ ثانیه سکوت
#         # بعد از "کیفیت، امضا ماست"
#         combined += silence_5s  # ۵ ثانیه سکوت
...
#     while len(music) < len(combined):
#         music += music
#     music = music - 15  # کاهش حجم موسیقی
#     combined = combined.overlay(music)
# else:
#     print("⚠️ فایل موسیقی Announcer-07.mp3 پیدا نشد. بدون موسیقی زمینه اجرا می‌شود.")
...
if os.path.exists(music_path):
    ...
    while len(music) < len(combined):
        music += music
    music = music - 15  # تنظیم بلندی موسیقی
    combined = combined.overlay(music)
else:
    print("⚠️ فایل موسیقی Announcer-07.mp3 پیدا نشد. بدون موسیقی زمینه اجرا می‌شود.")
